#############################################################################
# Makefile for building: MinionsCoin-Qt.app/Contents/MacOS/MinionsCoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed Feb 1 14:23:03 2017
# Project:  MinionsCoin-qt.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP=- USE_QRCODE=1 RELEASE=1 -o Makefile MinionsCoin-qt.pro
#############################################################################
...
CC            = clang
CXX           = clang++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -O2 -arch x86_64 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -fstack-protector-all --param ssp-buffer-size=1 -O2 -arch x86_64 -pthread -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/local/Cellar/qt/4.8.7_3/mkspecs/unsupported/macx-clang-libc++ -I/usr/local/Cellar/qt/4.8.7_3/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtCore.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/lib/QtGui.framework/Versions/4/Headers -I/usr/local/Cellar/qt/4.8.7_3/include -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -I/usr/local/Cellar/boost155/1.55.0_1/include -I/usr/local/Cellar/berkeley-db4/4.8.30/include -I/usr/local/Cellar/openssl-1.0.2j/include -I/usr/local/include -Ibuild -Ibuild -F/usr/local/Cellar/qt/4.8.7_3/lib
LINK          = clang++
LFLAGS        = -headerpad_max_install_names -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -fstack-protector-all --param ssp-buffer-size=1 -arch x86_64 -pthread
LIBS          = $(SUBLIBS) -F/usr/local/Cellar/qt/4.8.7_3/lib -L/usr/local/Cellar/qt/4.8.7_3/lib -lqrencode /Volumes/MacOSX/github/minions/src/leveldb/libleveldb.a /Volumes/MacOSX/github/minions/src/leveldb/libmemenv.a -framework Foundation -framework ApplicationServices -framework AppKit -L/usr/local/opt/boost155/lib -L/usr/local/Cellar/berkeley-db4/4.8.30/lib -L/usr/local/Cellar/openssl-1.0.2j/ -L/usr/local/lib -lssl -lcrypto -ldb_cxx-4.8 -lboost_system-mt -lboost_filesystem-mt -lboost_program_options-mt -lboost_thread-mt -framework QtGui -L/usr/local/opt/openssl/lib -L/usr/local/Cellar/qt/4.8.7_3/lib -F/usr/local/Cellar/qt/4.8.7_3/lib -framework QtCore 
AR            = ar cq
RANLIB        = ranlib -s
...
OBJECTS       = build/macdockiconhandler.o \
		...
		build/qrc_bitcoin.o
DIST          = /usr/local/Cellar/qt/4.8.7_3/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/qconfig.pri \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/modules/qt_webkit_version.pri \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/qt_functions.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/qt_config.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/exclusive_builds.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/default_pre.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/mac/default_pre.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/release.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/default_post.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/mac/default_post.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/mac/x86_64.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/mac/objective_c.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/unix/thread.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/shared.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/warn_on.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/qt.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/moc.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/mac/rez.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/mac/sdk.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/resources.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/uic.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/yacc.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/lex.prf \
		MinionsCoin-qt.pro
QMAKE_TARGET  = MinionsCoin-Qt
DESTDIR       = 
TARGET        = MinionsCoin-Qt.app/Contents/MacOS/MinionsCoin-Qt
...
all: Makefile MinionsCoin-Qt.app/Contents/PkgInfo MinionsCoin-Qt.app/Contents/Resources/empty.lproj MinionsCoin-Qt.app/Contents/Info.plist MinionsCoin-Qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Volumes/MacOSX/github/minions/src/leveldb/libleveldb.a /Volumes/MacOSX/github/minions/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) MinionsCoin-Qt.app/Contents/MacOS/ || $(MKDIR) MinionsCoin-Qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: MinionsCoin-qt.pro  /usr/local/Cellar/qt/4.8.7_3/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.7_3/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/clang.conf \
		...
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/yacc.prf \
		/usr/local/Cellar/qt/4.8.7_3/mkspecs/features/lex.prf \
		/usr/local/Cellar/qt/4.8.7_3/lib/QtGui.framework/QtGui.prl \
		/usr/local/Cellar/qt/4.8.7_3/lib/QtCore.framework/QtCore.prl
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 RELEASE=1 -o Makefile MinionsCoin-qt.pro
/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/unix.conf:
/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/mac.conf:
/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base.conf:
/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/gcc-base-macx.conf:
/usr/local/Cellar/qt/4.8.7_3/mkspecs/common/clang.conf:
...
distclean: clean
	-$(DEL_FILE) -r MinionsCoin-Qt.app
	-$(DEL_FILE) Makefile


/Volumes/MacOSX/github/minions/src/leveldb/libleveldb.a: FORCE
	cd /Volumes/MacOSX/github/minions/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-pipe -stdlib=libc++ -mmacosx-version-min=10.7 -mmacosx-version-min=10.7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/Volumes/MacOSX/github/minions/build/build.h: FORCE
	cd /Volumes/MacOSX/github/minions; /bin/sh share/genbuild.sh /Volumes/MacOSX/github/minions/build/build.h
...
src/qt/locale/bitcoin_af_ZA.qm: src/qt/locale/bitcoin_af_ZA.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_af_ZA.ts -qm src/qt/locale/bitcoin_af_ZA.qm

src/qt/locale/bitcoin_ar.qm: src/qt/locale/bitcoin_ar.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ar.ts -qm src/qt/locale/bitcoin_ar.qm

src/qt/locale/bitcoin_be_BY.qm: src/qt/locale/bitcoin_be_BY.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_be_BY.ts -qm src/qt/locale/bitcoin_be_BY.qm

src/qt/locale/bitcoin_bg.qm: src/qt/locale/bitcoin_bg.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_bg.ts -qm src/qt/locale/bitcoin_bg.qm

src/qt/locale/bitcoin_bs.qm: src/qt/locale/bitcoin_bs.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_bs.ts -qm src/qt/locale/bitcoin_bs.qm

src/qt/locale/bitcoin_ca.qm: src/qt/locale/bitcoin_ca.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ca.ts -qm src/qt/locale/bitcoin_ca.qm

src/qt/locale/bitcoin_ca@valencia.qm: src/qt/locale/bitcoin_ca@valencia.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ca@valencia.ts -qm src/qt/locale/bitcoin_ca@valencia.qm

src/qt/locale/bitcoin_ca_ES.qm: src/qt/locale/bitcoin_ca_ES.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ca_ES.ts -qm src/qt/locale/bitcoin_ca_ES.qm

src/qt/locale/bitcoin_cs.qm: src/qt/locale/bitcoin_cs.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_cs.ts -qm src/qt/locale/bitcoin_cs.qm

src/qt/locale/bitcoin_cy.qm: src/qt/locale/bitcoin_cy.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_cy.ts -qm src/qt/locale/bitcoin_cy.qm

src/qt/locale/bitcoin_da.qm: src/qt/locale/bitcoin_da.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_da.ts -qm src/qt/locale/bitcoin_da.qm

src/qt/locale/bitcoin_de.qm: src/qt/locale/bitcoin_de.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_de.ts -qm src/qt/locale/bitcoin_de.qm

src/qt/locale/bitcoin_el_GR.qm: src/qt/locale/bitcoin_el_GR.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_el_GR.ts -qm src/qt/locale/bitcoin_el_GR.qm

src/qt/locale/bitcoin_en.qm: src/qt/locale/bitcoin_en.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_en.ts -qm src/qt/locale/bitcoin_en.qm

src/qt/locale/bitcoin_eo.qm: src/qt/locale/bitcoin_eo.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_eo.ts -qm src/qt/locale/bitcoin_eo.qm

src/qt/locale/bitcoin_es.qm: src/qt/locale/bitcoin_es.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_es.ts -qm src/qt/locale/bitcoin_es.qm

src/qt/locale/bitcoin_es_CL.qm: src/qt/locale/bitcoin_es_CL.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_es_CL.ts -qm src/qt/locale/bitcoin_es_CL.qm

src/qt/locale/bitcoin_es_DO.qm: src/qt/locale/bitcoin_es_DO.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_es_DO.ts -qm src/qt/locale/bitcoin_es_DO.qm

src/qt/locale/bitcoin_es_MX.qm: src/qt/locale/bitcoin_es_MX.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_es_MX.ts -qm src/qt/locale/bitcoin_es_MX.qm

src/qt/locale/bitcoin_es_UY.qm: src/qt/locale/bitcoin_es_UY.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_es_UY.ts -qm src/qt/locale/bitcoin_es_UY.qm

src/qt/locale/bitcoin_et.qm: src/qt/locale/bitcoin_et.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_et.ts -qm src/qt/locale/bitcoin_et.qm

src/qt/locale/bitcoin_eu_ES.qm: src/qt/locale/bitcoin_eu_ES.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_eu_ES.ts -qm src/qt/locale/bitcoin_eu_ES.qm

src/qt/locale/bitcoin_fa.qm: src/qt/locale/bitcoin_fa.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_fa.ts -qm src/qt/locale/bitcoin_fa.qm

src/qt/locale/bitcoin_fa_IR.qm: src/qt/locale/bitcoin_fa_IR.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_fa_IR.ts -qm src/qt/locale/bitcoin_fa_IR.qm

src/qt/locale/bitcoin_fi.qm: src/qt/locale/bitcoin_fi.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_fi.ts -qm src/qt/locale/bitcoin_fi.qm

src/qt/locale/bitcoin_fr.qm: src/qt/locale/bitcoin_fr.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_fr.ts -qm src/qt/locale/bitcoin_fr.qm

src/qt/locale/bitcoin_fr_CA.qm: src/qt/locale/bitcoin_fr_CA.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_fr_CA.ts -qm src/qt/locale/bitcoin_fr_CA.qm

src/qt/locale/bitcoin_gl.qm: src/qt/locale/bitcoin_gl.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_gl.ts -qm src/qt/locale/bitcoin_gl.qm

src/qt/locale/bitcoin_he.qm: src/qt/locale/bitcoin_he.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_he.ts -qm src/qt/locale/bitcoin_he.qm

src/qt/locale/bitcoin_hi_IN.qm: src/qt/locale/bitcoin_hi_IN.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_hi_IN.ts -qm src/qt/locale/bitcoin_hi_IN.qm

src/qt/locale/bitcoin_hr.qm: src/qt/locale/bitcoin_hr.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_hr.ts -qm src/qt/locale/bitcoin_hr.qm

src/qt/locale/bitcoin_hu.qm: src/qt/locale/bitcoin_hu.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_hu.ts -qm src/qt/locale/bitcoin_hu.qm

src/qt/locale/bitcoin_id_ID.qm: src/qt/locale/bitcoin_id_ID.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_id_ID.ts -qm src/qt/locale/bitcoin_id_ID.qm

src/qt/locale/bitcoin_it.qm: src/qt/locale/bitcoin_it.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_it.ts -qm src/qt/locale/bitcoin_it.qm

src/qt/locale/bitcoin_ja.qm: src/qt/locale/bitcoin_ja.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ja.ts -qm src/qt/locale/bitcoin_ja.qm

src/qt/locale/bitcoin_ka.qm: src/qt/locale/bitcoin_ka.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ka.ts -qm src/qt/locale/bitcoin_ka.qm

src/qt/locale/bitcoin_kk_KZ.qm: src/qt/locale/bitcoin_kk_KZ.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_kk_KZ.ts -qm src/qt/locale/bitcoin_kk_KZ.qm

src/qt/locale/bitcoin_ko_KR.qm: src/qt/locale/bitcoin_ko_KR.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ko_KR.ts -qm src/qt/locale/bitcoin_ko_KR.qm

src/qt/locale/bitcoin_ky.qm: src/qt/locale/bitcoin_ky.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ky.ts -qm src/qt/locale/bitcoin_ky.qm

src/qt/locale/bitcoin_la.qm: src/qt/locale/bitcoin_la.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_la.ts -qm src/qt/locale/bitcoin_la.qm

src/qt/locale/bitcoin_lt.qm: src/qt/locale/bitcoin_lt.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_lt.ts -qm src/qt/locale/bitcoin_lt.qm

src/qt/locale/bitcoin_lv_LV.qm: src/qt/locale/bitcoin_lv_LV.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_lv_LV.ts -qm src/qt/locale/bitcoin_lv_LV.qm

src/qt/locale/bitcoin_ms_MY.qm: src/qt/locale/bitcoin_ms_MY.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ms_MY.ts -qm src/qt/locale/bitcoin_ms_MY.qm

src/qt/locale/bitcoin_nb.qm: src/qt/locale/bitcoin_nb.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_nb.ts -qm src/qt/locale/bitcoin_nb.qm

src/qt/locale/bitcoin_nl.qm: src/qt/locale/bitcoin_nl.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_nl.ts -qm src/qt/locale/bitcoin_nl.qm

src/qt/locale/bitcoin_pam.qm: src/qt/locale/bitcoin_pam.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_pam.ts -qm src/qt/locale/bitcoin_pam.qm

src/qt/locale/bitcoin_pl.qm: src/qt/locale/bitcoin_pl.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_pl.ts -qm src/qt/locale/bitcoin_pl.qm

src/qt/locale/bitcoin_pt_BR.qm: src/qt/locale/bitcoin_pt_BR.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_pt_BR.ts -qm src/qt/locale/bitcoin_pt_BR.qm

src/qt/locale/bitcoin_pt_PT.qm: src/qt/locale/bitcoin_pt_PT.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_pt_PT.ts -qm src/qt/locale/bitcoin_pt_PT.qm

src/qt/locale/bitcoin_ro_RO.qm: src/qt/locale/bitcoin_ro_RO.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ro_RO.ts -qm src/qt/locale/bitcoin_ro_RO.qm

src/qt/locale/bitcoin_ru.qm: src/qt/locale/bitcoin_ru.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ru.ts -qm src/qt/locale/bitcoin_ru.qm

src/qt/locale/bitcoin_sah.qm: src/qt/locale/bitcoin_sah.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_sah.ts -qm src/qt/locale/bitcoin_sah.qm

src/qt/locale/bitcoin_sk.qm: src/qt/locale/bitcoin_sk.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_sk.ts -qm src/qt/locale/bitcoin_sk.qm

src/qt/locale/bitcoin_sl_SI.qm: src/qt/locale/bitcoin_sl_SI.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_sl_SI.ts -qm src/qt/locale/bitcoin_sl_SI.qm

src/qt/locale/bitcoin_sq.qm: src/qt/locale/bitcoin_sq.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_sq.ts -qm src/qt/locale/bitcoin_sq.qm

src/qt/locale/bitcoin_sr.qm: src/qt/locale/bitcoin_sr.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_sr.ts -qm src/qt/locale/bitcoin_sr.qm

src/qt/locale/bitcoin_sv.qm: src/qt/locale/bitcoin_sv.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_sv.ts -qm src/qt/locale/bitcoin_sv.qm

src/qt/locale/bitcoin_th_TH.qm: src/qt/locale/bitcoin_th_TH.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_th_TH.ts -qm src/qt/locale/bitcoin_th_TH.qm

src/qt/locale/bitcoin_tr.qm: src/qt/locale/bitcoin_tr.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_tr.ts -qm src/qt/locale/bitcoin_tr.qm

src/qt/locale/bitcoin_uk.qm: src/qt/locale/bitcoin_uk.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_uk.ts -qm src/qt/locale/bitcoin_uk.qm

src/qt/locale/bitcoin_ur_PK.qm: src/qt/locale/bitcoin_ur_PK.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_ur_PK.ts -qm src/qt/locale/bitcoin_ur_PK.qm

src/qt/locale/bitcoin_vi.qm: src/qt/locale/bitcoin_vi.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_vi.ts -qm src/qt/locale/bitcoin_vi.qm

src/qt/locale/bitcoin_vi_VN.qm: src/qt/locale/bitcoin_vi_VN.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_vi_VN.ts -qm src/qt/locale/bitcoin_vi_VN.qm

src/qt/locale/bitcoin_zh_CN.qm: src/qt/locale/bitcoin_zh_CN.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_zh_CN.ts -qm src/qt/locale/bitcoin_zh_CN.qm

src/qt/locale/bitcoin_zh_TW.qm: src/qt/locale/bitcoin_zh_TW.ts
	/usr/local/Cellar/qt/4.8.7_3/bin/lrelease src/qt/locale/bitcoin_zh_TW.ts -qm src/qt/locale/bitcoin_zh_TW.qm
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp

build/moc_transactiontablemodel.cpp: src/qt/transactiontablemodel.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/transactiontablemodel.h -o build/moc_transactiontablemodel.cpp

build/moc_addresstablemodel.cpp: src/qt/addresstablemodel.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/addresstablemodel.h -o build/moc_addresstablemodel.cpp

build/moc_optionsdialog.cpp: src/qt/optionsdialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/optionsdialog.h -o build/moc_optionsdialog.cpp

build/moc_coincontroldialog.cpp: src/qt/coincontroldialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/coincontroldialog.h -o build/moc_coincontroldialog.cpp

build/moc_coincontroltreewidget.cpp: src/qt/coincontroltreewidget.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/coincontroltreewidget.h -o build/moc_coincontroltreewidget.cpp

build/moc_sendcoinsdialog.cpp: src/qt/sendcoinsdialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/sendcoinsdialog.h -o build/moc_sendcoinsdialog.cpp

build/moc_addressbookpage.cpp: src/qt/addressbookpage.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/addressbookpage.h -o build/moc_addressbookpage.cpp

build/moc_signverifymessagedialog.cpp: src/qt/signverifymessagedialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/signverifymessagedialog.h -o build/moc_signverifymessagedialog.cpp

build/moc_aboutdialog.cpp: src/qt/aboutdialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/aboutdialog.h -o build/moc_aboutdialog.cpp

build/moc_editaddressdialog.cpp: src/qt/editaddressdialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/editaddressdialog.h -o build/moc_editaddressdialog.cpp

build/moc_bitcoinaddressvalidator.cpp: src/qt/bitcoinaddressvalidator.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/bitcoinaddressvalidator.h -o build/moc_bitcoinaddressvalidator.cpp

build/moc_clientmodel.cpp: src/qt/clientmodel.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/clientmodel.h -o build/moc_clientmodel.cpp

build/moc_guiutil.cpp: src/qt/guiutil.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/guiutil.h -o build/moc_guiutil.cpp

build/moc_optionsmodel.cpp: src/qt/optionsmodel.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/optionsmodel.h -o build/moc_optionsmodel.cpp

build/moc_monitoreddatamapper.cpp: src/qt/monitoreddatamapper.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/monitoreddatamapper.h -o build/moc_monitoreddatamapper.cpp

build/moc_transactiondesc.cpp: src/qt/transactiondesc.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/transactiondesc.h -o build/moc_transactiondesc.cpp

build/moc_transactiondescdialog.cpp: src/qt/transactiondescdialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/transactiondescdialog.h -o build/moc_transactiondescdialog.cpp

build/moc_bitcoinamountfield.cpp: src/qt/bitcoinamountfield.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/bitcoinamountfield.h -o build/moc_bitcoinamountfield.cpp

build/moc_transactionfilterproxy.cpp: src/qt/transactionfilterproxy.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/transactionfilterproxy.h -o build/moc_transactionfilterproxy.cpp

build/moc_transactionview.cpp: src/qt/transactionview.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/transactionview.h -o build/moc_transactionview.cpp

build/moc_walletmodel.cpp: src/allocators.h \
		src/qt/walletmodel.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/walletmodel.h -o build/moc_walletmodel.cpp

build/moc_overviewpage.cpp: src/qt/overviewpage.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/overviewpage.h -o build/moc_overviewpage.cpp

build/moc_csvmodelwriter.cpp: src/qt/csvmodelwriter.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/csvmodelwriter.h -o build/moc_csvmodelwriter.cpp

build/moc_sendcoinsentry.cpp: src/qt/sendcoinsentry.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/sendcoinsentry.h -o build/moc_sendcoinsentry.cpp

build/moc_qvalidatedlineedit.cpp: src/qt/qvalidatedlineedit.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/qvalidatedlineedit.h -o build/moc_qvalidatedlineedit.cpp

build/moc_qvaluecombobox.cpp: src/qt/qvaluecombobox.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/qvaluecombobox.h -o build/moc_qvaluecombobox.cpp

build/moc_askpassphrasedialog.cpp: src/qt/askpassphrasedialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/askpassphrasedialog.h -o build/moc_askpassphrasedialog.cpp

build/moc_notificator.cpp: src/qt/notificator.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/notificator.h -o build/moc_notificator.cpp

build/moc_rpcconsole.cpp: src/qt/rpcconsole.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/rpcconsole.h -o build/moc_rpcconsole.cpp

build/moc_qrcodedialog.cpp: src/qt/qrcodedialog.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/qrcodedialog.h -o build/moc_qrcodedialog.cpp

build/moc_macdockiconhandler.cpp: src/qt/macdockiconhandler.h
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/macdockiconhandler.h -o build/moc_macdockiconhandler.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
	...
	/usr/local/Cellar/qt/4.8.7_3/bin/rcc -name bitcoin src/qt/bitcoin.qrc -o qrc_bitcoin.cpp
...
build/overviewpage.moc: src/qt/overviewpage.h \
		...
		src/qt/overviewpage.cpp
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/overviewpage.cpp -o build/overviewpage.moc
...
build/rpcconsole.moc: src/qt/rpcconsole.h \
		...
		src/qt/guiutil.h \
		src/qt/rpcconsole.cpp
	/usr/local/Cellar/qt/4.8.7_3/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/qt/rpcconsole.cpp -o build/rpcconsole.moc
...
build/ui_coincontroldialog.h: src/qt/forms/coincontroldialog.ui \
	...
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/coincontroldialog.ui -o build/ui_coincontroldialog.h

build/ui_sendcoinsdialog.h: src/qt/forms/sendcoinsdialog.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/sendcoinsdialog.ui -o build/ui_sendcoinsdialog.h

build/ui_addressbookpage.h: src/qt/forms/addressbookpage.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/addressbookpage.ui -o build/ui_addressbookpage.h

build/ui_signverifymessagedialog.h: src/qt/forms/signverifymessagedialog.ui \
		src/qt/qvalidatedlineedit.h
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/signverifymessagedialog.ui -o build/ui_signverifymessagedialog.h

build/ui_aboutdialog.h: src/qt/forms/aboutdialog.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/aboutdialog.ui -o build/ui_aboutdialog.h

build/ui_editaddressdialog.h: src/qt/forms/editaddressdialog.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/editaddressdialog.ui -o build/ui_editaddressdialog.h

build/ui_transactiondescdialog.h: src/qt/forms/transactiondescdialog.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/transactiondescdialog.ui -o build/ui_transactiondescdialog.h

build/ui_overviewpage.h: src/qt/forms/overviewpage.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/overviewpage.ui -o build/ui_overviewpage.h

build/ui_sendcoinsentry.h: src/qt/forms/sendcoinsentry.ui \
		src/qt/qvalidatedlineedit.h \
		src/qt/bitcoinamountfield.h
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/sendcoinsentry.ui -o build/ui_sendcoinsentry.h

build/ui_askpassphrasedialog.h: src/qt/forms/askpassphrasedialog.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/askpassphrasedialog.ui -o build/ui_askpassphrasedialog.h

build/ui_rpcconsole.h: src/qt/forms/rpcconsole.ui
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/rpcconsole.ui -o build/ui_rpcconsole.h

build/ui_optionsdialog.h: src/qt/forms/optionsdialog.ui \
		src/qt/bitcoinamountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/qvalidatedlineedit.h
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/optionsdialog.ui -o build/ui_optionsdialog.h

build/ui_qrcodedialog.h: src/qt/forms/qrcodedialog.ui \
		src/qt/bitcoinamountfield.h
	/usr/local/Cellar/qt/4.8.7_3/bin/uic src/qt/forms/qrcodedialog.ui -o build/ui_qrcodedialog.h
